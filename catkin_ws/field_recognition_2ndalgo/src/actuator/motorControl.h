...
public:
    ...
    void rotateUntilObjInWindow(double angularVel, Color objcolor, CamLaserGuide CLparam);     //obj captured by camera
    void rotateUntilNoObjInWindow(double angularVel, Color objcolor, CamLaserGuide CLparam);
