...
laserObject::laserObject():laserMaxDetectRange(LASER_MAX_DETECT_RANGE),sample_rate(10)
{
    ...
    laserSub = node.subscribe("/scan_laser", LASER_FIFO_LENGTH, &laserObject::scanCallback, this);
#else
    laserSub = node.subscribe("/base_scan_1", LASER_FIFO_LENGTH, &laserObject::scanCallback, this);
#endif
}
#endif
